...
# Função para filtrar criptomoedas com valor de mercado > 100 milhões e em tendência de alta
...
print("Criptomoedas próximas à EMA20, em tendência de alta e com valor de mercado acima de 100 milhões:")
